...
namespace GroupM.Minder
{
    public partial class Implementation_SpotPlan_IT : Form
    {
        ...
        string m_strScheduleExportPath = ConfigurationManager.AppSettings["ReportMinder"] + "Cue_IT.xlt";
        ...
        string m_strPOExportPath = ConfigurationManager.AppSettings["ReportMinder"] + "Cue_IT_Booking_Order.xlt";
        string m_strAdviceNoteExportPath = ConfigurationManager.AppSettings["ReportMinder"] + "Var_IT.xlt";
        ...
        public Implementation_SpotPlan_IT(string Username, string ScreenPermission, string BB, string v, int s, string mt, string mmt)
        {
        ...
        private void GvDetail_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Implementation_SpotPlan_IT_Amendment frm;
            if (m_MasterMediaType == "")
                frm = new Implementation_SpotPlan_IT_Amendment(screenMode, m_strMediaType);
            else
                frm = new Implementation_SpotPlan_IT_Amendment(screenMode, m_strMediaType, m_MasterMediaType);
            ...
            if (frm.ShowDialog() == DialogResult.OK)
            {
                ...
                dr["Deadline_Terminate"] = frm.txtBuyType.Text == "" ? "By Agency - Monthly" : frm.txtBuyType.Text;
                ...
                dr["ShowDate"] = frm.dtStartDate.Value.ToString("dd/MM/yyyy");
        ...
        private void btnAddDetail_Click(object sender, EventArgs e)
        {
            Implementation_SpotPlan_IT_Amendment frm;
            if (m_MasterMediaType == "")
                frm = new Implementation_SpotPlan_IT_Amendment("Add", m_strMediaType);
            else
                frm = new Implementation_SpotPlan_IT_Amendment("Add", m_strMediaType, m_MasterMediaType);
            ...
            if (frm.ShowDialog() == DialogResult.OK)
            {
                ...
                drAddDetail["Deadline_Terminate"] = frm.txtBuyType.Text == "" ? "By Agency - Monthly" : frm.txtBuyType.Text;
                ...
                drAddDetail["ShowDate"] = frm.dtStartDate.Value.ToString("dd/MM/yyyy");
        ...
        private void adviceNoteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet ds = m_db.SelectSpotPlanEditForAdviceNoteIT(m_strBuyingBriefID, m_strVersion, dtStamp, showX);
                //======================================
                // Create Result Excel
                //======================================

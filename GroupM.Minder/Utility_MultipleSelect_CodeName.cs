...
{
    public partial class Utility_MultipleSelect_CodeName : Form
    {
        ...
        public Utility_MultipleSelect_CodeName(string strCode, string strName, string strTable, DataTable dtSelected, string strUsername)
        {
            InitializeComponent();
        ...
        private void Utility_MultipleSelect_CodeName_Load(object sender, EventArgs e)
        {

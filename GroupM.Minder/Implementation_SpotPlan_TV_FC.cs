...
{
    public partial class Implementation_SpotPlan_TV_FC : Form
    {
        ...
        public Implementation_SpotPlan_TV_FC(string Username, string ScreenPermission, string BB, string v, int s, string mst)
        {
            InitializeComponent();
            username = Username;
        ...
        private void Implementation_SpotPlan_TV_FC_FormClosed(object sender, FormClosedEventArgs e)
        {
            //Modified by Chaiwat.i 25/08/2021

...
{
    public partial class frmProprietaryList : Form
    {
        public frmProprietaryList()
        {
            InitializeComponent();
        }
        ...
        {
            dtGvdetail = connect.SelectProprietaryList(filter);
        ...
        private void AddSelectData()
        {
            ...
            {
                MessageBox.Show("Proprietary not found! ", "MProprietary", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                if (gvDetail.SelectedRows.Count == 0)
                {
                    MessageBox.Show("Please select proprietary! ", "MProprietary", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
        ...
        private void frmProprietaryList_Load(object sender, EventArgs e)
        {
            DataLoading();
            txtSearch.Focus();
        }

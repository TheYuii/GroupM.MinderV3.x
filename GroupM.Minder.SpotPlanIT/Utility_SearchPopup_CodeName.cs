...
{
    public partial class Utility_SearchPopup_CodeName : Form
    {
        ...
        DBManager m_db;
        public Utility_SearchPopup_CodeName(string strCode, string strName, string strTable, bool bIncludeInactive, string strUsername, string strFilter)
        {
            InitializeComponent();
            MasterCode = strCode;
            MasterName = strName;
        ...
        private void Utility_SearchPopup_CodeName_Load(object sender, EventArgs e)
        {
